...
class MacDictionary(wx.Frame):
	...
	def InitUI(self):
		...
		self.cb0 = wx.CheckBox(main_panel, label = new_words_list[0][1])
		self.cb1 = wx.CheckBox(main_panel, label = new_words_list[1][1])
		self.cb2 = wx.CheckBox(main_panel, label = new_words_list[2][1])
		self.cb3 = wx.CheckBox(main_panel, label = new_words_list[3][1])
		self.cb4 = wx.CheckBox(main_panel, label = new_words_list[4][1])
		self.cb5 = wx.CheckBox(main_panel, label = new_words_list[5][1])
		self.cb6 = wx.CheckBox(main_panel, label = new_words_list[6][1])
		self.cb7 = wx.CheckBox(main_panel, label = new_words_list[7][1])
		self.cb8 = wx.CheckBox(main_panel, label = new_words_list[8][1])
		self.cb9 = wx.CheckBox(main_panel, label = new_words_list[9][1])
		...
		#self.comment_editor.WriteText('Hello world.') ###It does work.
		#下面是save/change/close的
		#button Change/Close
		...
		#关于TextCtrl:
		#event:	1,wx.EVT_TEXT, when text is changed.
		#method: 1, GetLineText, 
	    #		 2, IsModified
	...
	def OnSaveModified(self,e):
		...
		new_words_list[self.checkbox_flag][2]=Modified_text
		print 'checked',self.checkbox_flag,type(Modified_text),'\n',Modified_text, \
				'\n',new_words_list[self.checkbox_flag][2]
	
	def cb0_checked(self,e):
		if self.cb0.IsChecked():
			self.checkbox_flag = 0
			self.comment_editor.ChangeValue(new_words_list[0][2])
			self.Show_StatusText(new_words_list[0][1]+' Is checked.')
		else:
	...
	def cb1_checked(self,e):
		if self.cb1.IsChecked():
			...
			self.comment_editor.ChangeValue(new_words_list[1][2])
			self.Show_StatusText(new_words_list[1][1]+' Is checked.')
		else:
			self.Show_StatusText('')
	...
	def cb2_checked(self,e):
		if self.cb2.IsChecked():
			...
			self.comment_editor.ChangeValue(new_words_list[2][2])
			self.Show_StatusText(new_words_list[2][1]+' Is checked.')
		else:
			self.Show_StatusText('')
	...
	def cb3_checked(self,e):
		if self.cb3.IsChecked():
			...
			self.comment_editor.ChangeValue(new_words_list[3][2])
			self.Show_StatusText(new_words_list[3][1]+' Is checked.')
		else:
			self.Show_StatusText('')
	...
	def cb4_checked(self,e):
		if self.cb4.IsChecked():
			...
			self.comment_editor.ChangeValue(new_words_list[4][2])
			self.Show_StatusText(new_words_list[4][1]+' Is checked.')
		else:
			self.Show_StatusText('')
	...
	def cb5_checked(self,e):
		if self.cb5.IsChecked():
			...
			self.comment_editor.ChangeValue(new_words_list[5][2])
			self.Show_StatusText(new_words_list[5][1]+' Is checked.')
		else:
			self.Show_StatusText('')
	...
	def cb6_checked(self,e):
		if self.cb6.IsChecked():
			...
			self.comment_editor.ChangeValue(new_words_list[6][2])
			self.Show_StatusText(new_words_list[6][1]+' Is checked.')
		else:
			self.Show_StatusText('')
	...
	def cb7_checked(self,e):
		if self.cb7.IsChecked():
			...
			self.comment_editor.ChangeValue(new_words_list[7][2])
			self.Show_StatusText(new_words_list[7][1]+' Is checked.')
		else:
			self.Show_StatusText('')
	...
	def cb8_checked(self,e):
		if self.cb8.IsChecked():
			...
			self.comment_editor.ChangeValue(new_words_list[8][2])
			self.Show_StatusText(new_words_list[8][1]+' Is checked.')
		else:
			self.Show_StatusText('')
	...
	def cb9_checked(self,e):
		if self.cb9.IsChecked():
			...
			self.comment_editor.ChangeValue(new_words_list[9][2])
			self.Show_StatusText(new_words_list[9][1]+' Is checked.')
		else:
			self.Show_StatusText('')
	...
	def OnSetting(self,e):
		...
		path_textctrl = wx.TextCtrl(panel,size=(320,20))
		hbox1.Add(path_textctrl, proportion=1)
