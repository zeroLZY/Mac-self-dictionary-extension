...
class MacDictionary(wx.Frame):
	...
	def RE_setlabel(self):
		self.cb0 = wx.CheckBox(self.main_panel, label = self.new_words_list[0][1],size=(100,25))
		self.cb1 = wx.CheckBox(self.main_panel, label = self.new_words_list[1][1],size=(100,25))
		self.cb2 = wx.CheckBox(self.main_panel, label = self.new_words_list[2][1],size=(100,25))
		self.cb3 = wx.CheckBox(self.main_panel, label = self.new_words_list[3][1],size=(100,25))
		self.cb4 = wx.CheckBox(self.main_panel, label = self.new_words_list[4][1],size=(100,25))
		self.cb5 = wx.CheckBox(self.main_panel, label = self.new_words_list[5][1],size=(100,25))
		self.cb6 = wx.CheckBox(self.main_panel, label = self.new_words_list[6][1],size=(100,25))
		self.cb7 = wx.CheckBox(self.main_panel, label = self.new_words_list[7][1],size=(100,25))
		self.cb8 = wx.CheckBox(self.main_panel, label = self.new_words_list[8][1],size=(100,25))
		self.cb9 = wx.CheckBox(self.main_panel, label = self.new_words_list[9][1],size=(100,25))
